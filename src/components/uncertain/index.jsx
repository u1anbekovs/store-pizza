            ...
            <svg width="300" height="255" viewBox="0 0 300 255" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_45_0)">
                    <path
                        ...
                        fill="#F8F8F8"/>
                    <path d="M197.278 173.629L156.709 91.0457C155.471 90.3018 150.502 87.0103 150.502 87.0103"
                          stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path
                        d="M153.799 97.5847C153.314 95.933 151.86 92.5295 151.86 92.5295C150.972 92.4735 144.789 89.194 144.789 89.194"
                        stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M143.02 89.498L162.244 81.4112" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round"
                          strokeLinejoin="round"/>
                    <path d="M4.94175 215.646L0 220.353L11.8618 236.391L15.5312 233.043L9.8835 218.774L4.94175 215.646Z"
                          fill="black"/>
                    <path
                    ...
                    <path
                        ...
                        stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M158.477 123.353H273.577" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round"
                          strokeLinejoin="round"/>
                    <path d="M161.658 140.878H273.577" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round"
                          strokeLinejoin="round"/>
                    <path d="M133.288 93.5893L143.02 89.498" stroke="#DFDFDF" strokeWidth="5" strokeLinecap="round"
                          strokeLinejoin="round"/>
                    <path d="M171.398 140.878C170.137 137.202 156.763 97.7487 156.763 97.7487" stroke="#DFDFDF"
