...
import {clearItems, setModal} from "../../redux/slices/cardSlice";
import Uncertain from "../uncertain";
import Buy from "./buy";

const Basket = () => {
    const dispatch = useDispatch()
    const {items, totalPrice, modal} = useSelector(state => state.cardSlice)
    ...
    return (
        <div className={style.cart}>
            <div className={style.cart__top}>
                ...
                <div className={style.cart__clear} onClick={onClickClear}>
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8.33337 9.16667V14.1667" stroke="black" strokeWidth="1.2" strokeLinecap="round"
                              strokeLinejoin="round"/>
                        <path d="M11.6666 9.16667V14.1667" stroke="black" strokeWidth="1.2" strokeLinecap="round"
                              strokeLinejoin="round"/>
                    </svg>
            ...
            <div className={style.cart__bottom}>
                ...
                <div className={style.cart__bottomDetails}>
                    <span>Всего пицц: <b>{totalCount} шт.</b>{' '}</span>
                    <span>Итого: <b>{totalPrice} c.</b>{' '}</span>
                </div>

                <div className={style.cart__bottomButtons}>
                    <Link to="/" className={style.prev__btn}>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path d="M7 13L1 6.93015L6.86175 1" stroke="black" strokeWidth="1.5"
                                  strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>

                        <span>Вернуться назад</span>
                    </Link>
                    <div onClick={() => dispatch(setModal(!modal))} className={style.pay__btn}>
                        <span>Заказать</span>
                    </div>
                    {
                        modal ? '' : <Buy/>
